...
class TestCsvFile(unittest.TestCase):
    ...
    def test_csvfl_csvToList_1(self):
        countRows = 0
        countColumns = 0
        global newData
    ...
    def test_csvfl_csvToList_2(self):
    ...
    def test_csvfl_csvToList_3(self):
    ...
    def test_csvfl_csvToList_4(self):
    ...
    @unittest.skip("I don't wanna create any file as a result.")
    def test_csvfl_listToCsv_1(self):
        global newData
        directory = dataDir + "\\"
    ...
    @unittest.skip("I don't wanna create any file as a result.")
    def test_csvfl_listToCsv_1_2(self):
        global newData
        directory = dataDir + "\\"
    ...
    @unittest.skip("Bug.")
    def test_csvfl_listToCsv_2(self):
        directory = dataDir + "\\"
    ...
    @unittest.skip("Bug.") 
    def test_csvfl_listToCsv_3(self):
        global newData
        directory = dataDir + "\\"
    ...
    @unittest.skip("Bug.")         
    def test_csvfl_listToCsv_4(self):
        global newData
